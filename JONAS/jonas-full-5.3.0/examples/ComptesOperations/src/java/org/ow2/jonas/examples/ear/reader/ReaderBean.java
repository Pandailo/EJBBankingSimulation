...
import static org.ow2.jonas.examples.ear.entity.Operation.QN.ALL_OPERATIONS;
import static org.ow2.jonas.examples.ear.entity.Operation.QN.FIND_OPERATION;
...
public class ReaderBean implements LocalReader, RemoteReader {
     ...
     */
    @SuppressWarnings("unchecked")
    public Operation findOperation(final int id) {
