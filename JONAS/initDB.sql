create table Compte(id NUMBER(6) NOT NULL PRIMARY KEY,balance NUMBER(12));
create table Operations(
	id NUMBER(12) NOT NULL PRIMARY KEY,typeOpe VARCHAR(25),amount NUMBER(12),compte NUMBER(6), 
	CONSTRAINT fk_accountid FOREIGN KEY (compte) REFERENCES Accounts(id),
	CONSTRAINT c_type CHECK (typeOpe IN ('retrait','depot'))
);
